...
row5 = (Cl(STK)-SMA(Cl(STK),10))/SMA(Cl(STK),10) < (-0.045)
row6 = (Cl(STK)-SMA(Cl(STK),10))/SMA(Cl(STK),10) > (-0.045)
row7 = (Cl(STK)-SMA(Cl(STK),10))/SMA(Cl(STK),10) > 0.05
row8 = (Cl(STK)-SMA(Cl(STK),10))/SMA(Cl(STK),10) < 0.05
...
for(m in 11:nrow(STK)){
  if(PZ==0 && row5[m-1]==1 && row6[m]==1){
    long=as.numeric(Cl(STK)[m]*(1+0.001425))
    PZ=1
    
  }
  if(PZ!=0 && row7[m-1]==1 && row8[m]==1){
